...
#The difference is that now there is no reading of recovery file. Fixed length of linked region.
#python statistics_bigwindow_pylibseq_SingExon_msmc.py -LinkCutoff numbp50 -folder eqm_disc_5 -simID 1
...
if folder == "demo_neutral_SingExon_msmc":
    ...
    f_par = open("/home/pjohri1/MSMC/programs_abc/demo_disc_parameters+5_SingExon_msmc_testset.txt", 'r') 
elif folder == "demo_disc_5_SingExon_msmc_recombination":
    f_par = open("/home/pjohri1/MSMC/programs_abc/demo_disc_parameters+5_SingExon_msmc_recombination.txt", 'r')
elif folder == "demo_disc_5_SingExon_msmc_noscaling":
    f_par = open("/home/pjohri1/MSMC/programs_abc/demo_disc_parameters+5_SingExon_msmc_noscaling.txt", 'r')
d_col = {}
for line in f_par:
    line1 = line.strip('\n')
    line2 = line1.split('\t')
...
numbp = 894.4272 #This is numbp50
