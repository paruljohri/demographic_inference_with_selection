...
#Files are named as follows: MASTER_${SNP_density}_${chr_size}_rep${replicate_num}_DAFpop0.obs
#where
...
#Files are named as follows: MASTER_${SNP_density}_${demographic_model}_${masking_state}_${exon_density}_sim${DFE}_rep${replicate_num}_DAFpop0.obs
where
