...
def analyze_msmc_results(number_of_msmc_replicates, max_plotted_generation, bin_size, demographic_model, masking_state, exon_density, DFE_number, mutation_rate):         
    ...
    for k in range(1, number_of_msmc_replicates + 1):
        msmc_results_file = '$$$/msmc_output_files/variable_rec_and_mut/RAW_rep' + str(k) + '_' + demographic_model + '_DFE' + str(DFE_number) + '_' + exon_density + '_' + masking_state + '.txt'
...
GRAPH_exon_density = ['genome05', 'genome10', 'genome20'] #Denotes the exon desnity, with, for example, genome20 referring to the genome containing 20% exons.
